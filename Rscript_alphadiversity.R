...
NBA <- import_qiime2(otu_qza = "verum.qza", taxa_qza = "taxonomy.qza",
  sam_tab = "ESANII_Metadaten_22_detailedgroups.txt")
...
#olfaction <- levels(ps1.meta$group) # get the variables/for more than 2 variables
polyphenol <- unique(ps1.meta$group) # for 2 variables

# make a pairwise list that we want to compare.
#olfaction.pairs <- combn(seq_along(olfaction), 2, simplify = FALSE, FUN = function(i)olfaction[i]) # if you have more than 2 variables
